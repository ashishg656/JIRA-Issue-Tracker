 ...
 */
public class SelectTypesFragmentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<Issuetype> mData;
    ...
    public SelectTypesFragmentListAdapter(Context context, List<Issuetype> mData, List<String> selectedAlready) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderCom, int position) {
        ...
        Issuetype issuetype = mData.get(position);
        ...
        holder.name.setText(issuetype.getName());
        holder.email.setMaxLines(1);
        holder.email.setEllipsize(TextUtils.TruncateAt.END);
        holder.email.setText(issuetype.getDescription());

        holder.imageNonCircular.setVisibility(View.VISIBLE);
        holder.image.setVisibility(View.GONE);

        try {
            if (issuetype.getIconUrl() != null) {
                String url = issuetype.getIconUrl();
    ...
    private class UserHolder extends RecyclerView.ViewHolder {
        ...
        public UserHolder(View v) {
            ...
            imageNonCircular = (ImageView) v.findViewById(R.id.circularimageImageIssueType);
        }
    }
