 ...
 */
public class SelectProjectFragmentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderCom, int position) {
        ...
        ProjectListingObject project = mData.get(position);
        ...
        holder.email.setText("Key : " + project.getKey());

        try {
            if (project.getAvatarUrls() != null && project.getAvatarUrls().get48x48() != null) {
                String url = project.getAvatarUrls().get48x48();
