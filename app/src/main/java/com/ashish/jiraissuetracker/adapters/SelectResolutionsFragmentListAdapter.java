 ...
 */
public class SelectResolutionsFragmentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<Resolution> mData;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderCom, int position) {
        ...
        Resolution resolution = mData.get(position);
        ...
        holder.name.setText(resolution.getName());
